...
namespace Rhema.Data.Extensions
{
    public static partial class DapperExtension
    {
        ...
        public static async Task<T> GetByIdSql<T>(this IDbConnection conn, ISqlBuilder builder, string returnFields="", object param = null, IDbTransaction tran = null, int? commandTimeout = null)
        {

            return await conn.QueryFirstOrDefaultAsync<T>(builder.GetByIdSql<T>(returnFields), param, tran, commandTimeout);
        }
    }
}
